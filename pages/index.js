  ...
  return (
    <main className={styles.container}>
      ...
      <div className='flex-container'>
        ...
        <div className='card'>
          <Image className='image' src='/v_and_v.jpeg' width="400" height="562" />

          <Link href={"post"}>
            <h2>"Спектакль «Валентин и Валентина» по пьесе М.Рощина</h2>
          </Link>

          <p>Спектакль о любви двух молодых людей, которые сталкиваются с непониманием со стороны 
            семей, личные истории актеров вплетаются в сценическое повествование, делая спектакль 
            лирическим и близким современной молодежи. Молодые актеры Санкт-Петербургского 
            государственного института культуры. МАСТЕРСКАЯ З.А.РСФСР М.И.САМОЧКО. 
            Хронометраж 2,5 ч с антрактом. </p>
